  ...
  <div class="shadow-2xl rounded-3xl m-5" style="background-color: #374151">
    <div class="p-5">
      ...
      <p>
        ...
        OnServerInit if you do not agree to take all of the terms and conditions stated on this
        page.
      </p>
      <p>
      ...
      <p>
        We employ the use of cookies. By accessing OnServerInit, you agreed to use cookies in agreement
        with the OnServerInit's Privacy Policy.
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, OnServerInit and/or its licensors own the intellectual property rights
        for all material on OnServerInit. All intellectual property rights are reserved. You may access
        this from OnServerInit for your own personal use subjected to restrictions set in these terms
        and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from OnServerInit</li>
        <li>Sell, rent or sub-license material from OnServerInit</li>
        <li>Reproduce, duplicate or copy material from OnServerInit</li>
        <li>Redistribute content from OnServerInit</li>
      </ul>
      <p>
        This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the
        help of the <a href="https://www.privacypolicies.com/blog/sample-terms-conditions-template/">Terms
          And Conditions Template</a>.
      </p>
      <p>
        Parts of this website offer an opportunity for users to post and exchange opinions and
        information in certain areas of the website. OnServerInit does not filter, edit, publish or
        review Comments prior to their presence on the website. Comments do not reflect the views and
        opinions of OnServerInit,its agents and/or affiliates. Comments reflect the views and opinions
        of the person who post their views and opinions. To the extent permitted by applicable laws,
        OnServerInit shall not be liable for the Comments or for any liability, damages or expenses
        caused and/or suffered as a result of any use of and/or posting of and/or appearance of the
        Comments on this website.
      </p>
      <p>
        OnServerInit reserves the right to monitor all Comments and to remove any Comments which can be
      ...
      <p>
        You hereby grant OnServerInit a non-exclusive license to use, reproduce, edit and authorize
      ...
      <p>
        ...
        hyperlink compensates the absence of OnServerInit; and (d) the link is in the context of general
      ...
      <p>
        ...
        our website, you must inform us by sending an e-mail to OnServerInit. Please include your name,
      ...
      <p>
        No use of OnServerInit's logo or other artwork will be allowed for linking absent a trademark
        license agreement.
      </p>
      ...
      <p>
        Please read <NuxtLink to="/privacy">
          Privacy Policy
        </NuxtLink>
      </p>
